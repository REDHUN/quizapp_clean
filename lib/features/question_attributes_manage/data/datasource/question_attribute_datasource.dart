...
class QuestionAttributeDatasource {
  ...
  Future<CategoryModel> addQuestionCategory(
    ...
    var request = await dio.post("/api/admin/questions/saveCategory",
        data: queryParameter);

    CategoryModel category = CategoryModel.fromJson(request.data);
    return category;
  }

  Future<bool> isCategoryUser({int? categoryId}) async {
    var request = await dio.get("/api/questions/isCategoryUsed/$categoryId");

    return request.data;
  }

  Future<bool> deleteCategory({int? categoryId}) async {
    var request = await dio.delete("/api/questions/deleteCategory/$categoryId");
